...
class ChartPage extends StatefulWidget {
  final List<ChartEntity> chatyEntity;

  const ChartPage({Key key, this.chatyEntity}) : super(key: key);
  @override
  _FoodOrderPageState createState() => _FoodOrderPageState();
}

class _FoodOrderPageState extends State<ChartPage> {
  int counter = 3;

  @override
  Widget build(BuildContext context) {
    log(widget.chatyEntity.toString());
    return Scaffold(
        appBar: AppBar(
